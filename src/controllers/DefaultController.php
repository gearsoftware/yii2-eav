...
use gearsoftware\eav\models\EavCategories;
...
/**
 * EavEntityController implements the CRUD actions for gearsoftware\eav\models\EavEntity model.
 */
            ...
            try {
                ...
                if ($model instanceof EavCategories) {
                    ...
                    if ($categories && !empty($categories)) {
                        $categories = ArrayHelper::merge(['' => Yii::t('core', 'Not Selected')], $categories);
